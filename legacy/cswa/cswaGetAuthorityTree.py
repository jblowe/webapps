...
if __name__ == "__main__":
    ...
    print 'starting to get some places from omca-dev'
    # get some places and materials from PAHMA-dev
    connect_string    = "host=dba-postgres-dev-32.ist.berkeley.edu port=5107 dbname=omca_domain_omca user=reporter_omca password=xxxinsertpasswordherexxx sslmode=require"
