...
# media handling
psql omca_domain_omca -U csadmin -c "UPDATE id_generators SET last_generated_id = '', id_generator_state = '<org.collectionspace.services.id.SettableIDGenerator>
  <parts>
    ...
    <org.collectionspace.services.id.YearIDGeneratorPart>
      <currentValue>2023</currentValue>
    </org.collectionspace.services.id.YearIDGeneratorPart>
    <org.collectionspace.services.id.StringIDGeneratorPart>
