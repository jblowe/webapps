...
echo Status of nightly Solr refresh
echo
echo please verify timestamps, number of rows, errors
echo
...
echo
echo checking for refresh pipeline errors
wc -l /home/webapps/solr-pipelines/errors.*.csv
