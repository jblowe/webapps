...
<div class="table" id=""" + code + """table>
  ...
  <span class="useBody">&nbsp;&nbsp;&nbsp;&nbsp;Absolutely, as long as the data is in CSpace. If you have suggestions for other statistics, please send your suggestion to <a href="mailto:omca-cspace@berkeley.edu?Subject=Comment%20on%20Collection%20Stats" target="_top">omca-cspace@berkeley.edu</a></span>
</div>
"""
